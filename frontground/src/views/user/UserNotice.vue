...
<template>
	<div class="notic-container">
		...
		<div class="pagination-footer">
			<el-pagination
				v-model:current-page="noticForm.page"
				v-model:page-size="noticForm.pageSize"
				:page-sizes="[10, 20, 30, 40]"
				layout="total, sizes, prev, pager, next, jumper"
				:total="noticForm.total"
				@size-change="queryNotic"
